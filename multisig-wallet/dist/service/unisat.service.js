...
exports.getRuneInfo = exports.fetchRuneHolderList = exports.sendInscription = void 0;
...
const fetchRuneHolderList = (runeId) => __awaiter(void 0, void 0, void 0, function* () {
    const url = `${config_1.OPENAPI_UNISAT_URL}/v1/indexer/runes/${runeId}/holders`;
    const config = {
        headers: {
    ...
    console.log("result in fetchRuneHolderList ==> ", result.data);
    if (result.data.data) {
        const holderList = result.data.data.detail;
        return holderList;
    }
    else {
        return null;
...
exports.fetchRuneHolderList = fetchRuneHolderList;
const getRuneInfo = (runeId) => __awaiter(void 0, void 0, void 0, function* () {
    const url = `${config_1.OPENAPI_UNISAT_URL}/v1/indexer/runes/${runeId}/info`;
    const config = {
        headers: {
            Authorization: `Bearer ${config_1.OPENAPI_UNISAT_TOKEN}`,
        },
    ...
    console.log("result in fetchRuneHolderList ==> ", result.data);
    if (result.data.data) {
        const spacedRune = result.data.data.spacedRune;
        return spacedRune;
    }
    else {
        return null;
...
exports.getRuneInfo = getRuneInfo;
